        ...
        <div className='min-h-[200px] flex flex-col lg:flex-row gap-4'>
            <div className='h-96 flex flex-col lg:flex-row-reverse gap-4'>
                <div className='h-[300px] w-[300px] lg:h-96 lg:w-96 bg-slate-200 relative p-2'>
                    <img src={activeImage} alt={data?.productName} className='h-full w-full object-scale-down mix-blend-multiply' onMouseMove={handleImageZoom} onMouseLeave={handleLeaveImageZoom} />
                                    ...
                                    data?.image?.map((img, index)=>{
                                        return(
                                            <div className='h-20 w-20 bg-slate-200 rounded p-1' key={img} >
                                                <img src={img} alt={data?.productName} className='w-full h-full object-scale-down mix-blend-multiply cursor-pointer' onMouseEnter={()=>handleMouseEnter(img)} onClick={()=>handleMouseEnter(img)} />
                                            </div>
                                        )
                                    })
                                }
