...
const Success = () => {
  return (
    <div className='bg-blue-400 w-full max-w-md mx-auto flex flex-col justify-center items-center p-4 m-2 rounded'>
        ...
        <Link to={"/orders"} className='p-2 px-3 mt-5 border-2 border-green-300 rounded font-semibold text-green-300 hover:bg-green-300 hover:text-white'>See Order</Link>
    </div>
  )
}
